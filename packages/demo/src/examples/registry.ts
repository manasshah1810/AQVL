...
export const EXAMPLES: Example[] = [
  ...
  // ── Heaps ─────────────────────────────────────────────────────────────────────
  // Every example is the real algorithm (loops, IFs, FUNCTIONs over h[i]), not a built-in.
  {
    id: 'heaps-index-map',
    title: 'Heap Index Map',
    category: 'Heaps',
    description: 'Walk every index of a heap and work out its parent and children from 2i + 1, 2i + 2 and (i - 1) / 2 rounded down: no pointers needed.',
    difficulty: 'Easy',
    source: HeapScripts.HeapIndexMap,
  },
  {
    id: 'heaps-is-valid',
    title: 'Is It a Min-Heap?',
    category: 'Heaps',
    description: 'Check every parent against its children with a LOOP and IFs, marking each pair that breaks the min-heap rule.',
    difficulty: 'Easy',
    source: HeapScripts.IsValidMinHeap,
  },
  {
    id: 'heaps-insert',
    title: 'Insert and Sift Up',
    category: 'Heaps',
    description: 'Add each arriving value as the new last cell, then a siftUp FUNCTION swaps it with its parent while it is smaller.',
    difficulty: 'Medium',
    source: HeapScripts.MinHeapInsert,
  },
  {
    id: 'heaps-extract-min',
    title: 'Extract Minimum',
    category: 'Heaps',
    description: 'An extractMin FUNCTION moves the last value onto the root, deletes the last cell and sifts the root down, returning the smallest value.',
    difficulty: 'Medium',
    source: HeapScripts.ExtractMin,
  },
  {
    id: 'heaps-max-heap-auction',
    title: 'Max-Heap: Auction Bids',
    category: 'Heaps',
    description: 'The same sift code with the comparisons flipped keeps the highest bid on top; three items are sold to the highest remaining bids.',
    difficulty: 'Medium',
    source: HeapScripts.MaxHeapAuction,
  },
  {
    id: 'heaps-build-bottom-up',
    title: 'Build Heap Bottom-Up (Floyd)',
    category: 'Heaps',
    description: 'Turn an unordered array into a min-heap in O(n) by sifting down every parent from the last one back to the root, counting the swaps.',
    difficulty: 'Medium',
    source: HeapScripts.BuildHeapBottomUp,
  },
  {
    id: 'heaps-heapify-recursive',
    title: 'Heapify (Recursive)',
    category: 'Heaps',
    description: 'A recursive heapify FUNCTION fixes one broken node, then calls itself on the child that received the bigger value.',
    difficulty: 'Medium',
    source: HeapScripts.HeapifyRecursive,
  },
  {
    id: 'heaps-decrease-key',
    title: 'Decrease Key',
    category: 'Heaps',
    description: 'Lower a distance in place and sift it up, as Dijkstra\'s algorithm does; an increase is rejected with a message.',
    difficulty: 'Medium',
    source: HeapScripts.DecreaseKey,
  },
  {
    id: 'heaps-delete-at-index',
    title: 'Delete at Any Index',
    category: 'Heaps',
    description: 'Fill the hole with the last value, then decide with IFs whether it must sift up or sift down; both cases are shown.',
    difficulty: 'Hard',
    source: HeapScripts.DeleteAtIndex,
  },
  {
    id: 'heaps-heap-sort',
    title: 'Heap Sort (In Place)',
    category: 'Heaps',
    description: 'Build a max-heap, then repeatedly swap the root to the end of the unsorted part and repair the shrunken heap.',
    difficulty: 'Hard',
    source: HeapScripts.HeapSortInPlace,
  },
  {
    id: 'heaps-emergency-room',
    title: 'Emergency Room Triage',
    category: 'Heaps',
    description: 'A max-heap priority queue of severities with a parallel array of patient names: the most urgent patient is always seen first.',
    difficulty: 'Medium',
    source: HeapScripts.EmergencyRoom,
  },
  {
    id: 'heaps-top-k-scores',
    title: 'Top K Scores',
    category: 'Heaps',
    description: 'Keep a min-heap of the best k scores seen so far; a new score gets in only if it beats the root. O(n log k).',
    difficulty: 'Medium',
    source: HeapScripts.TopKScores,
  },
  {
    id: 'heaps-kth-smallest',
    title: 'Kth Smallest Delivery Time',
    category: 'Heaps',
    description: 'Put every delivery time in a min-heap and remove the root k - 1 times: the root is then the k-th smallest.',
    difficulty: 'Easy',
    source: HeapScripts.KthSmallest,
  },
  {
    id: 'heaps-connect-ropes',
    title: 'Connect Ropes at Minimum Cost',
    category: 'Heaps',
    description: 'Greedy with a min-heap: always join the two shortest ropes and put the joined rope back, adding up the cost.',
    difficulty: 'Medium',
    source: HeapScripts.ConnectRopes,
  },
  {
    id: 'heaps-last-stone',
    title: 'Last Stone Weight',
    category: 'Heaps',
    description: 'Smash the two heaviest stones taken from a max-heap; if they differ, the leftover stone goes back into the heap.',
    difficulty: 'Easy',
    source: HeapScripts.LastStoneWeight,
  },
  {
    id: 'heaps-running-median',
    title: 'Running Median (Two Heaps)',
    category: 'Heaps',
    description: 'A max-heap for the smaller half and a min-heap for the bigger half give the median after every new number.',
    difficulty: 'Hard',
    source: HeapScripts.RunningMedian,
  },

  // ── Hash Maps ─────────────────────────────────────────────────────────────────
  {
    id: 'hashmaps-hash-function',
    title: 'Hash Function by Hand',
    category: 'Hash Maps',
    description: 'A hashOf FUNCTION adds up character codes in a LOOP and takes the remainder, matches BUCKET_OF, and spots collisions: anagrams always share a bucket.',
    difficulty: 'Easy',
    source: HashMapScripts.HashFunctionByHand,
  },
  {
    id: 'hashmaps-phone-book',
    title: 'Phone Book: Store, Update, Look Up, Delete',
    category: 'Hash Maps',
    description: 'The four basic moves: m[key] = value adds or overwrites, CONTAINS guards every read of a key that may be missing, DELETE removes a contact.',
    difficulty: 'Easy',
    source: HashMapScripts.PhoneBook,
  },
  {
    id: 'hashmaps-collisions',
    title: 'Collisions and Chaining',
    category: 'Hash Maps',
    description: 'Locker numbers that leave the same remainder pile up in one bucket\'s chain; a FUNCTION counts how many comparisons each lookup needs.',
    difficulty: 'Easy',
    source: HashMapScripts.CollisionsAndChaining,
  },
  {
    id: 'hashmaps-load-factor',
    title: 'Load Factor and Resizing',
    category: 'Hash Maps',
    description: 'Watch size / capacity after every insert: past 0.75 the bucket row doubles (8, 16, 32) and every key is rehashed into its new bucket.',
    difficulty: 'Medium',
    source: HashMapScripts.LoadFactorAndResize,
  },
  {
    id: 'hashmaps-shopping-cart',
    title: 'Shopping Cart Totals',
    category: 'Hash Maps',
    description: 'Two maps (price list and cart): add quantities with IF CONTAINS / ELSE, then walk every key with KEY_AT to total the bill and apply a discount.',
    difficulty: 'Easy',
    source: HashMapScripts.ShoppingCartTotals,
  },
  {
    id: 'hashmaps-open-addressing',
    title: 'Open Addressing by Hand',
    category: 'Hash Maps',
    description: 'A hash table built from two plain arrays with linear probing: insert and search FUNCTIONs step to the next slot until they find a free one or the key.',
    difficulty: 'Medium',
    source: HashMapScripts.OpenAddressingByHand,
  },
  {
    id: 'hashmaps-word-frequency',
    title: 'Word Frequency Counter',
    category: 'Hash Maps',
    description: 'Split a sentence into words with CHAR_AT, count each word in a map through a countWord FUNCTION, then find the most frequent word.',
    difficulty: 'Easy',
    source: HashMapScripts.WordFrequencyCounter,
  },
  {
    id: 'hashmaps-first-unique',
    title: 'First Non-Repeating Character',
    category: 'Hash Maps',
    description: 'Pass 1 counts every character in a map; pass 2 walks the text in order and stops at the first character counted once.',
    difficulty: 'Easy',
    source: HashMapScripts.FirstUniqueCharacter,
  },
  {
    id: 'hashmaps-valid-anagram',
    title: 'Valid Anagram',
    category: 'Hash Maps',
    description: 'An isAnagram FUNCTION adds 1 for each letter of one word and subtracts 1 for the other; anagrams leave every letter at 0.',
    difficulty: 'Easy',
    source: HashMapScripts.ValidAnagram,
  },
  {
    id: 'hashmaps-two-sum',
    title: 'Two Sum in One Pass',
    category: 'Hash Maps',
    description: 'For each number, look up the partner it needs (target - number) among the numbers already seen: O(n) instead of trying every pair.',
    difficulty: 'Easy',
    source: HashMapScripts.TwoSum,
  },
  {
    id: 'hashmaps-first-duplicate',
    title: 'First Reused Ticket',
    category: 'Hash Maps',
    description: 'A stadium gate remembers where each ticket was first scanned and stops at the first ticket scanned twice.',
    difficulty: 'Easy',
    source: HashMapScripts.FirstDuplicate,
  },
  {
    id: 'hashmaps-longest-consecutive',
    title: 'Longest Consecutive Run',
    category: 'Hash Maps',
    description: 'Store every number in a map used as a set, then count up only from numbers whose predecessor is missing: O(n) without sorting.',
    difficulty: 'Medium',
    source: HashMapScripts.LongestConsecutiveRun,
  },
  {
    id: 'hashmaps-subarray-sum',
    title: 'Subarrays That Add Up to K',
    category: 'Hash Maps',
    description: 'Count how often each running (prefix) sum has appeared; every earlier prefix equal to sum - k closes one subarray adding up to k.',
    difficulty: 'Hard',
    source: HashMapScripts.SubarraySumEqualsK,
  },
  {
    id: 'hashmaps-longest-substring',
    title: 'Longest Substring Without Repeats',
    category: 'Hash Maps',
    description: 'A sliding window with a map of where each letter was last seen: a repeat inside the window moves the window\'s start past it.',
    difficulty: 'Medium',
    source: HashMapScripts.LongestSubstringWithoutRepeats,
  },
  {
    id: 'hashmaps-election',
    title: 'Election Tally',
    category: 'Hash Maps',
    description: 'Count ballots per candidate, then walk the map to find the winner, with a separate branch for a tie.',
    difficulty: 'Easy',
    source: HashMapScripts.ElectionTally,
  },
  {
    id: 'hashmaps-ransom-note',
    title: 'Ransom Note',
    category: 'Hash Maps',
    description: 'Count the letters a magazine offers, then spend them one by one on the note, stopping at the first letter that runs out.',
    difficulty: 'Easy',
    source: HashMapScripts.RansomNote,
  },
  {
    id: 'hashmaps-memo-fibonacci',
    title: 'Memoized Fibonacci',
    category: 'Hash Maps',
    description: 'A recursive fib FUNCTION remembers every answer in a map, so each fib(n) is computed once and asked again in a single lookup.',
    difficulty: 'Medium',
    source: HashMapScripts.MemoizedFibonacci,
  },
